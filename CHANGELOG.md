...
## [Unreleased]
### Added
- Recursive QtQuick child lookup and QML item interaction commands
- A pytest plugin alongside the existing nose plugin
- QWidget and QML focus-cycling functional tests

### Changed
- CMake and functional test applications support VS2022/MSVC and Qt6
